...
res = openai.ChatCompletion.create(
    ...
    messages=[{"role": "assistant", "content": "我现在是一名分析师"},
              {"role": "user","content": 'Buy $RON @ERC20DeSantis this is the only meme coin investment that can pull a 100X on its own. It already hit $9m and fully retracted. ' + '\n该内容中作者对什么代币($开头)持乐观态度'}])
# print(res)
